...
namespace MyCustomClasses
{
    public static class Gelbooru
    {
        ...
        public static HtmlDocument GetPageHTML(WebClient wc, string url, int indexPage = -1)
        {
            if (indexPage > -1)
            {
        ...
        public static string GetUrlUseMirror(string url)
        {
            ...
            const string MIRROR_URL = "https://sitenable.top/o.php?b=4&f=norefer&_senable_sig=&pv=0&mobile=&u=";
        ...
        {
            const string MIRROR_URL = "https://sitenable.top";
